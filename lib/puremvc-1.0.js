...
var Controller, DefineNamespace, Facade, MacroCommand, Mediator, Model, Notification, Notifier, Observer, Proxy, SimpleCommand, View,
  __slice = [].slice,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

DefineNamespace = function(target, name, block) {
...
DefineNamespace('puremvc', function(exports) {
  return exports.DefineNamespace = DefineNamespace;
});
...
puremvc.DefineNamespace('puremvc', function(exports) {
